...
section .data
    ...
    bind_suc_msg        db "Binding socket to listening address successed", 0x0a, 0
    ...
    lstn_suc_msg        db "Listening...", 0x0a, 0
    lstn_suc_msg_len    equ $ - lstn_suc_msg
...
_listen:
    ...
    mov         rsi, lstn_suc_msg
    mov         rdx, lstn_suc_msg_len
    mov         rax, 1 ; SYS_WRITE
    mov         rdi, 1 ; STDOUT
    syscall
    ret
